...
class Seq2seqCNN(nn.Module):
    def __init__(self, window_length=599, n_dense=1, target_length=599, transfer_cnn=False, cnn_weights=None):
        ...
        self.output = nn.Linear(1024, target_length)
    ...
    def forward(self, x):
        ...
        returns: y: [batch_size, window_length] -- device power usage
        ...
        output: linear layer: output [batch_size, window_length], Linear 
        '''
