...
class Dataset_AEMO_old(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='AEMO.csv',
                 target='OT', scale=True, timeenc=0, freq='t', 
                 percent=100, max_len=-1, train_all=False):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 5 * 12
            self.label_len = 24 * 12
            self.pred_len = 24 * 12
        else:
            self.seq_len = size[0]
            self.label_len = size[1]
    ...
    def __read_data__(self):
        ...
        self.data_x = data[border1:border2]
        # print('1', self.data_x.shape)
        self.data_y = data[border1:border2]
        # print('2', self.data_y.shape)
        self.data_stamp = data_stamp
...
class Dataset_AEMO(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='AEMO.csv',
                 target='NSW', scale=True, timeenc=0, freq='t', 
                 percent=100, max_len=-1, train_all=True, region='NSW'):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 5 * 12
...
class Dataset_Norwegian(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='M', data_path='load_data.csv',
                 target='OT', scale=True, timeenc=0, freq='h', 
                 percent=100, max_len=-1, train_all=True):
        # size [seq_len, label_len, pred_len]
        # info
        if size == None:
            self.seq_len = 24 * 5 * 1
...
class Dataset_EWELD(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='S', data_path='load_data.csv',
                 target='OT', scale=True, timeenc=0, freq='t', 
                 percent=100, max_len=-1, train_all=True):
        # size [seq_len, label_len, pred_len]
        # info
...
class Dataset_REFIT(Dataset):
    def __init__(self, root_path, flag='train', size=None,
                 features='MS', data_path='load_data.csv',
                 target='OT', scale=True, timeenc=0, freq='t', 
    ...
    def __len__(self):
        return int((len(self.data_x) - self.seq_len + 1)/self.seq_len)
